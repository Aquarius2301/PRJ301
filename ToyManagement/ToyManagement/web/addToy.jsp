        ...
        <script>
            function validateForm() {
                ...
                if (id === "") {
                    ...
                    idWarning.innerHTML = "ID must be a number greater than 0";
                    isValidate = false;
                }
                if (name === "") {
            ...
            <div class="login-container">
                ...
                <form action="add" method="post" onsubmit="return validateForm()">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id"  placeholder="Enter the ID" name="id" value="<%=request.getParameter("id")==null?"":request.getParameter("id")%>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="category" placeholder="Enter the category" name="category"  value="<%=request.getParameter("category")==null?"":request.getParameter("category")%>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="quantity" placeholder="Enter the quantity" name="quantity"  value="<%=request.getParameter("quantity")==null?"":request.getParameter("quantity")%>">
                        <p id="quantityWarning" class="warning"></p>
                    </div>
                    <button class= "btn btn-primary" type="submit">Add</button>
                    <p id= "abc" name="warning" class="warning">${warning}</p>
                </form>
            </div>
        </div>
    </body>
